        ...
        _fields: [
          {
            ...
            properties: {
              ...
              price: 20,
              description:
                'Toast, spice and juicy citrus flavors blend together in this crisp wine. Its acidity is prominent, giving plenty of freshness to a wine that is also tangy. With the toastiness now well integrated, the wine is ready to drink.',
        ...
        _fields: [
          {
            ...
            properties: {
              ...
              price: 30,
              description:
                'A blend of 13 different grape varieties, some rare, this is a delicious, honeyed wine, with rich baked apple flavor and crisp acidity, topped with a creamed spice note. Its pure line of citrus provides a lively finish.',
    ...
    return (
      <div>
        <Grid>
          <Grid.Row>
            <div>
              <h3>We also think you\'ll like:</h3>
            </div>
          </Grid.Row>
          <Grid.Row>
